...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        },
        {
          ...
          alt: "Successful entrepreneur avatar",
        },
        {
      ...
      marqueeItems={[
        ...
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/view-puzzle-pieces-blue-background_23-2149299057.jpg",
          alt: "Automation gear icon",
        },
        {
          type: "text",
        ...
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/bright-neon-colors-illuminated-arrow_23-2151204944.jpg",
        ...
        {
          type: "image",
          src: "http://img.b2bpic.net/free-vector/service-day-icons-set-arrow-style_1017-30334.jpg",
          alt: "Clock icon",
        },
        {
          type: "text",
        ...
        {
          type: "image",
          src: "http://img.b2bpic.net/free-vector/colorful-speech-balloons-set_1025-424.jpg",
          alt: "Chat bubble icon",
        },
        {
          type: "text",
          text: "Zero Missed Leads",
        },
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/green-check-mark-symbol-icon-sign-correct-right-approve-concept-confirm-illustration-isolated-green-background-3d-rendering_56104-1220.jpg",
          alt: "Checkmark icon",
        },
      ]}
      marqueeSpeed={40}
      ...
      features={[
        {
          ...
          description: "A student enquires at 10pm.\\\nNo reply. By morning —\\\nthey've joined your competitor.",
          imageSrc: "http://img.b2bpic.net/free-vector/gamification-motivation-flat-elements-set_1284-24974.jpg",
          imageAlt: "Abstract icon representing leads after hours",
        },
        {
          title: "Staff Doing Robot Work",
          description: "Answering the same question\\\n100 times a day.\\\nThat's a machine's job — not theirs.",
          imageSrc: "http://img.b2bpic.net/free-vector/set-business-teamwork-strategy-information_24640-45214.jpg",
          imageAlt: "Abstract icon representing repetitive staff work",
        },
        {
          title: "Fee Reminders Forgotten",
          description: "Manual follow-ups get missed.\\\nParents don't pay on time.\\\nCash flow suffers every month.",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-black-friday-sales-elements-composition_23-2148665629.jpg",
          imageAlt: "Abstract icon representing forgotten fee reminders",
        },
      ]}
      ...
      metrics={[
        {
          id: "solution-1",
          value: "01",
          description: "Instant Lead Response: Every enquiry gets a reply in seconds — day or night. No lead left behind. Ever.",
        },
        {
          id: "solution-2",
          value: "02",
          description: "Automated Follow-Ups: Students get the right message at the right time — automatically. Without anyone pressing send.",
        },
        {
          id: "solution-3",
          value: "03",
          description: "Smart Fee Reminders: Reminders go out on schedule. Collections improve. Your team stays focused.",
        },
      ]}
      ...
      blogs={[
        {
          ...
          category: "Step 01",
          title: "Free Audit",
          excerpt: "We study your workflow. Find exactly where you're losing leads and time.",
          imageSrc: "http://img.b2bpic.net/free-vector/technology-infographic_23-2147490790.jpg",
          imageAlt: "Abstract icon representing a free audit",
          authorName: "Arkonex",
          authorAvatar: "http://img.b2bpic.net/free-photo/abstract-cube-futuristic-cyberpunk-style_187299-48040.jpg",
          date: "2025-01-01",
        },
        {
          id: "step-2",
          category: "Step 02",
          title: "Custom Design",
          excerpt: "We design a system built for your institute — not a generic template.",
          imageSrc: "http://img.b2bpic.net/free-vector/design-thinking-25-blue-color-icon-pack-including-drawing-light-geometry-compass_1142-24706.jpg",
          imageAlt: "Abstract icon representing custom design",
          authorName: "Arkonex",
          authorAvatar: "http://img.b2bpic.net/free-photo/smartphone-displayed-within-geometric-wireframe_187299-46683.jpg",
          date: "2025-01-02",
        },
        {
          id: "step-3",
          category: "Step 03",
          title: "We Build It",
          excerpt: "You don't touch anything. We build, test, and keep you updated.",
          imageSrc: "http://img.b2bpic.net/free-vector/modern-productivity-concept-with-flat-design_23-2147968944.jpg",
          imageAlt: "Abstract icon representing building and testing",
          authorName: "Arkonex",
          authorAvatar: "http://img.b2bpic.net/free-photo/premium-shadow-style-typography-black-background_53876-104955.jpg",
          date: "2025-01-03",
        },
        {
          id: "step-4",
          category: "Step 04",
          title: "You Go Live",
          excerpt: "System launches. Leads handled. Follow-ups running. You just watch it work.",
          imageSrc: "http://img.b2bpic.net/free-vector/creative-information-technology-25-glyph-solid-black-icon-pack-such-as-connection-interfaces-telecommunication-data-management_1142-22460.jpg",
          imageAlt: "Abstract icon representing going live and results",
          authorName: "Arkonex",
          authorAvatar: "http://img.b2bpic.net/free-vector/bikers-gear-badge_23-2147504357.jpg",
          date: "2025-01-04",
        },
      ]}
      ...
      faqs={[
        {
          id: "service-audit",
          title: "Free AI Audit",
          content: "20 minutes. We study your institute and show you exactly what can be automated. Zero cost. Zero obligation.",
        },
        {
          id: "service-starter",
          title: "Starter AI System",
          content: "Your first intelligent system — built and delivered. Lead capture, instant replies, automatic follow-ups. Ready in days.",
        },
        {
          id: "service-suite",
          title: "Complete AI Suite",
          content: "Everything automated. Leads, follow-ups, fee reminders — all running without your team lifting a finger.",
        },
      ]}
      title="What We Offer"
      ...
      team={[
        {
          ...
          imageAlt: "Professional portrait of Piyush, AI Systems Architect",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      textarea={{
        name: "message",
        placeholder: "Tell us about your institute and challenges...",
        rows: 4,
        required: false,
      }}
  ...
  <div id="footer" data-section="footer">
      ...
      socialLinks={[
        {
          icon: Linkedin,
          href: "https://linkedin.com/arkonex",
          ariaLabel: "LinkedIn",
        },
        {
          icon: Twitter,
          href: "https://twitter.com/arkonex",
          ariaLabel: "Twitter",
        },
        {
          icon: Mail,
          href: "mailto:info@arkonex.com",
          ariaLabel: "Email",
        },
      ]}
      links={[
